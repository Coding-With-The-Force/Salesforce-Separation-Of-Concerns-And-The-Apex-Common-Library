...
To find out how to implement the Domain Layer using Apex Common, continue reading here: <a href="https://github.com/Coding-With-The-Force/Salesforce-Separation-Of-Concerns-And-The-Apex-Common-Library/wiki/11)-Implementing-The-Domain-Layer--with-the-Apex-Common-Library" target="_blank">Implementing the Domain Layer with the Apex Common Library</a>. If you're not interested in utilizing the Apex Common library for this layer you can implement really any trigger framework and the core of the domain layer will be covered.
...
<a href="https://github.com/Coding-With-The-Force/Salesforce-Separation-Of-Concerns-And-The-Apex-Common-Library/wiki/11)-Implementing-The-Domain-Layer--with-the-Apex-Common-Library" target="_blank">Part 11: Implementing the Domain Layer with the Apex Common Library</a>     
