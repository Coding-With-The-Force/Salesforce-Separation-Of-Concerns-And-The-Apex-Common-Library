...
[![Unit Test Mocks and Separation of Concerns](https://yt-embed.herokuapp.com/embed?v=TzRohBbp8dw)](https://youtu.be/TzRohBbp8dw "Unit Test Mocks and Separation of Concerns")
...
<a href="https://github.com/Coding-With-The-Force/Salesforce-Separation-Of-Concerns-And-The-Apex-Common-Library/wiki/17)-Implementing-Mock-Unit-Tests-with-the-Apex-Mocks-Library" target="_blank">Part 17: Implementing Mock Unit Testing with Apex Mocks</a> 