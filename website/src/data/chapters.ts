...
export const CHAPTERS: Chapter[] = [
  {
    ...
    blurb:
      'Why splitting a system by concern is the only way it stays legible past a few thousand lines.',
    video: 'nU4TKRFzdx4',
    duration: '18:42',
    read: '6 min',
    template: 'standard',
  ...
  },
  {
    ...
    blurb: "What fflib actually gives you, and the parts you can safely ignore on day one.",
    video: '3JmWECi77zU',
    duration: '15:20',
    read: '5 min',
    template: 'standard',
  ...
  },
  {
    ...
    blurb:
      'The abstract factory every other layer resolves through. The longest chapter here.',
    video: 'pUvDyNXNFNs',
    duration: '32:15',
    read: '22 min',
    template: 'annotated',
  ...
  },
  {
    ...
    blurb: 'registerNew, registerDirty, registerRelationship, and commitWork.',
    video: 'T14iEOcy_Kg',
    duration: '28:47',
    read: '9 min',
    template: 'standard',
  ...
  },
  {
    ...
    blurb: "Where business logic lives, why it's stateless, and why it's global.",
    video: '5tM_MHV1ypY',
    duration: '24:08',
    read: '10 min',
    template: 'standard',
  ...
  },
  {
    ...
    blurb:
      'Interface, implementation class, and wiring it into the Application factory.',
    video: 'nj9O-qWEeXg',
    duration: '35:22',
    read: '14 min',
  ...
  },
  {
    ...
    blurb: 'An object model of the domain that incorporates both behaviour and data.',
    video: 'ZUDwBW2PftA',
    duration: '21:04',
    read: '8 min',
    template: 'standard',
  ...
  },
  {
    ...
    blurb: 'fflib_SObjectDomain, Constructor inner classes, and the trigger handler.',
    video: '9kbUvY1uMIE',
    duration: '38:50',
    read: '13 min',
    template: 'implementation',
  ...
  },
  {
    ...
    blurb: 'Fluent query construction, without a single line of string concatenation.',
    video: 'frke3NN0F90',
    duration: '17:29',
    read: '9 min',
    template: 'pattern',
  ...
  },
  {
    ...
    blurb: 'Every line of SOQL you own, in one testable, reusable place.',
    video: 'cPU6D-TpLvs',
    duration: '27:31',
    read: '7 min',
    template: 'standard',
  ...
  },
  {
    ...
    blurb: 'fflib_SObjectSelector, field sets, and the QueryFactory.',
    video: '-ZZbRA2-Gew',
    duration: '36:14',
    read: '16 min',
    template: 'implementation',
  ...
  },
  {
    ...
    blurb: 'Why SoC is the thing that makes true unit testing possible at all.',
    video: 'TzRohBbp8dw',
    duration: '26:40',
    read: '11 min',
    template: 'standard',
  ...
  },
  {
    ...
    blurb:
      'fflib_ApexMocks, stubbing, verify(), and argument captors. The big one.',
    video: 'PLSrLc6jjwQ',
    duration: '41:19',
    read: '33 min',
    template: 'implementation',
