...
8) **_[newQueryFactory](https://github.com/apex-enterprise-patterns/fflib-apex-common/blob/master/sfdx-source/apex-common/main/classes/fflib_SObjectSelector.cls#L350)_** - This method returns a new instance of the fflib_QueryFactory class and uses your selector classes fields listed in the getSObjectFieldList method and orders them by whatever you set the default orderby to in your selector class.
