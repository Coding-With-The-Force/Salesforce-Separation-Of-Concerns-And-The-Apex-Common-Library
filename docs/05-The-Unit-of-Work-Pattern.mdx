...
If you're not sure what mocking and unit test are, then definitely check out [my section on that in the wiki here](/apex-mocks/unit-vs-integration-tests/). Basically, in an ideal scenario you would like to do unit testing, but unit testing depends on you having the ability to mock classes for your tests (basically creating fake versions of your class you have complete control over in your tests). Creating this layer that handles your dml transactions allows you to mock that layer in your classes when doing unit tests... If this is confusing, no worries, we'll discuss it a bunch more later in the last three sections of this wiki.
